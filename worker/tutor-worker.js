...
function systemPrompt(helpLevel) {
  return [
    ...
    "Gib nicht sofort die vollstaendige Loesung preis.",
    "Finde zuerst heraus, wo der/die Studierende haengt.",
    "Gib pro Antwort hoechstens einen naechsten sinnvollen Hinweis.",
    ...
    "Bei Hilfestufe 0: stelle vor allem eine Rueckfrage.",
    "Bei Hilfestufe 1: gib einen kleinen Hinweis ohne Zahlenrechnung.",
    "Bei Hilfestufe 2: nenne die passende Formel oder den Ansatz.",
    "Bei Hilfestufe 3: zeige genau den naechsten Rechenschritt mit den gegebenen Zahlen.",
