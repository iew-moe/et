...
def draw_phasor(vectors):
    ...
    ax.set_xticks(ticks)
    ax.set_yticks(ticks)
    ax.tick_params(axis='both', labelsize=8, labelcolor='tab:blue')
    ...
    secx.tick_params(axis='x', labelsize=8, labelcolor='tab:red')
    secx.tick_params(axis='x', labelrotation=90)
    secy.tick_params(axis='y', labelsize=8, labelcolor='tab:red')
    secx.set_xlabel("")
    secy.set_ylabel("")
    ...
    ax2.tick_params(axis='both', labelsize=8, labelcolor='tab:blue')
    ...
    secx2.tick_params(axis='x', labelsize=8, labelcolor='tab:red')
    secx2.tick_params(axis='x', labelrotation=90)
    secy2.tick_params(axis='y', labelsize=8, labelcolor='tab:red')
